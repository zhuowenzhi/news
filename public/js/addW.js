! function (e, t) {
    ...
    function i(o) {
        if (o) {
            ...
            var A = o.nodeType,
                r = [];
            9 === A ? r = [o] : 1 === A ? r = [o] : t(o) || o instanceof Array ? r = o : "string" == typeof o && (o =
    ...
    function p(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-font"></i></div>'), this.type =
            "droplist", this._active = !1;
        var n = e.config,
            i = n.fontNames || [];
    ...
    function m(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-link"></i></div>'), this.type =
    ...
    function S(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-table2"></i></div>'), this.type =
            "panel", this._active = !1
    }

    function k(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-play"></i></div>'), this.type =
            "panel", this._active = !1
    }
    ...
    function D(e) {
        this.editor = e;
        var t = c("w-e-img");
        this.$elem = o('<div class="w-e-menu" id="' + t + '"><i class="w-e-icon-image"></i></div>'), e.imgMenuId =
            t, this.type = "panel", this._active = !1
    }
    ...
    function N(e) {
        var t = e.clipboardData || e.originalEvent && e.originalEvent.clipboardData,
            n = void 0;
        return n = null == t ? window.clipboardData && window.clipboardData.getData("text") : t.getData(
            "text/plain"), a(n)
    }
    ...
    function F(e, t, n) {
        var i = e.clipboardData || e.originalEvent && e.originalEvent.clipboardData,
            o = void 0,
            A = void 0;
        if (null == i ? o = window.clipboardData && window.clipboardData.getData("text") : (o = i.getData(
                "text/plain"), A = i.getData("text/html")), !A && o && (A = "<p>" + a(o) + "</p>"), A) {
            var r = A.split("</html>");
            return 2 === r.length && (A = r[0]), A = A.replace(/<(meta|script|link).+?>/gim, ""), A = A.replace(
                /<!--.*?-->/gm, ""), A = A.replace(/\s?data-.+?=('|").+?('|")/gim, ""), n && (A = A.replace(
                /<img.+?>/gim, "")), A = t ? A.replace(/\s?(class|style)=('|").*?('|")/gim, "") : A.replace(
                /\s?class=('|").*?('|")/gim, "")
        }
    }
    ...
    i.prototype = {
        ...
        css: function (e, t) {
            ...
            return this.forEach(function (t) {
                ...
                }), A.indexOf(n) < 0 && A.push(n), t.setAttribute("style", A.join("; "))) : t.setAttribute(
                    "style", n)
            })
        },
        show: function () {
    ...
    var z = {
            ...
            colors: ["#000000", "#eeece0", "#1c487f", "#4d80bf", "#c24f4a", "#8baa4a", "#7b5ba1", "#46acc8",
                "#f9963b", "#ffffff"],
            emotions: [{
                title: "默认",
                type: "image",
    ...
    l.prototype = {
        ...
        onClick: function (e) {
            ...
            n && t.selection.createEmptyRange(), t.cmd.do("bold"), n && (t.selection.collapseRange(), t.selection
                .restoreSelection())
        },
        tryChangeActive: function (e) {
            var t = this.editor,
                n = this.$elem;
            t.cmd.queryCommandState("bold") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !
    ...
    d.prototype = {
        ...
        tryChangeActive: function (e) {
            ...
            i.test(o) ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass(
                "w-e-active"))
        }
    }, h.prototype = {
        constructor: h,
    ...
    f.prototype = {
            ...
            if (!(K.indexOf(t) >= 0)) {
                ...
                h.forEach(function (e, t) {
                    if (e) {
                        ...
                        l.append(r);
                        var c = o(A);
                        d.append(c), r._index = t, p.push(r), f.push(c), 0 === t ? (r._active = !0,
                            r.addClass("w-e-active")) : c.hide(), r.on("click", function (e) {
        ...
        onClick: function (e) {
            ...
            if (this._active) {
                ...
                t.selection.createRangeByElem(n), t.selection.restoreSelection(), this._createPanel(n.text(),
                    n.attr("href"))
            } else t.selection.isSelectionEmpty() ? this._createPanel("", "") : this._createPanel(t.selection
                .getSelectionText(), "")
        },
            ...
            var n = this,
                ...
                l = new f(this, {
                    ...
                    tabs: [{
                        title: "链接",
                        tpl: '<div>\n                            <input id="' + A +
                            '" type="text" class="block" value="' + e +
                            '" placeholder="链接文字"/></td>\n                            <input id="' +
                            i + '" type="text" class="block" value="' + t +
                            '" placeholder="http://..."/></td>\n                            <div class="w-e-button-container">\n                                <button id="' +
                            r +
                            '" class="right">插入</button>\n                                <button id="' +
                            a + '" class="gray right" style="display:' + s +
                            '">删除链接</button>\n                            </div>\n                        </div>',
                        events: [{
                            selector: "#" + r,
                            type: "click",
        ...
        tryChangeActive: function (e) {
            ...
            i && ("A" === i.getNodeName() ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !
                1, n.removeClass("w-e-active")))
        }
    }, g.prototype = {
        constructor: g,
        onClick: function (e) {
            var t = this.editor,
                n = t.selection.isSelectionEmpty();
            n && t.selection.createEmptyRange(), t.cmd.do("italic"), n && (t.selection.collapseRange(), t.selection
                .restoreSelection())
        },
        tryChangeActive: function (e) {
            var t = this.editor,
                n = this.$elem;
            t.cmd.queryCommandState("italic") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !
                1, n.removeClass("w-e-active"))
        }
    }, w.prototype = {
        constructor: w,
        ...
        tryChangeActive: function (e) {
            var t = this.editor,
                n = this.$elem;
            t.cmd.queryCommandState("strikeThrough") ? (this._active = !0, n.addClass("w-e-active")) : (
        ...
        tryChangeActive: function (e) {
            var t = this.editor,
                n = this.$elem;
            t.cmd.queryCommandState("underline") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !
                1, n.removeClass("w-e-active"))
        }
    }, b.prototype = {
        constructor: b,
        ...
        _command: function (e) {
            ...
            if (t.selection.restoreSelection(), !t.cmd.queryCommandState(e)) {
                ...
                if ("LI" === i.getNodeName() && (i = i.parent()), !1 !== /^ol|ul$/i.test(i.getNodeName()) &&
                    !i.equal(n)) {
                    var o = i.parent();
        ...
        tryChangeActive: function (e) {
            ...
            t.cmd.queryCommandState("insertUnOrderedList") || t.cmd.queryCommandState("insertOrderedList") ?
                (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass(
                    "w-e-active"))
        }
    }, y.prototype = {
        constructor: y,
        ...
        onClick: function (e) {
            var t = this.editor,
                n = t.selection.getSelectionContainerElem(),
                i = n.getNodeName();
            if (!J.isIE()) return void("BLOCKQUOTE" === i ? t.cmd.do("formatBlock", "<P>") : t.cmd.do(
                "formatBlock", "<BLOCKQUOTE>"));
            var A = void 0,
                r = void 0;
            if ("P" === i) return A = n.text(), r = o("<blockquote>" + A + "</blockquote>"), r.insertAfter(
                n), void n.remove();
        ...
        onClick: function (e) {
            var t = this.editor,
                ...
                c = void 0;
            return n.equal(i) ? A ? void(this._active ? this._createPanel(n.html()) : this._createPanel()) :
                (c = o("<code>" + r + "</code>"), t.cmd.do("insertElem", c), t.selection.createRangeByElem(
                    c, !1), void t.selection.restoreSelection()) : void t.selection.restoreSelection()
        },
                    ...
                    tabs: [{
                        ...
                        events: [{
                            ...
                            fn: function () {
                                var e = o("#" + i),
                                    A = e.val() || e.html();
                                return A = a(A), "new" === n ? t._insertCode(A) : t
                                    ._updateCode(A), !0
                            }
                        }]
                    }]
        ...
        tryChangeActive: function (e) {
            ...
            if (i) {
                var o = i.parent();
                "CODE" === i.getNodeName() && "PRE" === o.getNodeName() ? (this._active = !0, n.addClass(
                    "w-e-active")) : (this._active = !1, n.removeClass("w-e-active"))
            }
        }
    }, M.prototype = {
        constructor: M,
        ...
        _createPanel: function () {
            ...
            i.forEach(function (t) {
                ...
                "emoji" === n && i.forEach(function (e) {
                    ...
                    var t = e.src,
                        n = e.alt;
                    t && (r += '<span class="w-e-item"><img src="' + t + '" alt="' + n +
                        '" data-w-e="1"/></span>')
                }), A.push({
                    title: t.title,
                    ...
                    events: [{
                        ...
                        fn: function (t) {
                            var n = t.target,
                                ...
                                A = i.getNodeName(),
                                r = void 0;
                            return r = "IMG" === A ? i.parent().html() :
                                "<span>" + i.html() + "</span>", e._insert(r),
                                !0
                        }
                    }]
                })
        ...
        _insert: function (e, t) {
            ...
            o += "</table><p><br></p>";
            var A = this.editor;
            A.cmd.do("insertHTML", o), A.cmd.do("enableObjectResizing", !1), A.cmd.do(
                "enableInlineTableEditing", !1)
        },
        ...
        tryChangeActive: function (e) {
            ...
            if (i) {
                var o = i.getNodeName();
                "TD" === o || "TH" === o ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !
                    1, n.removeClass("w-e-active"))
            }
        }
    }, k.prototype = {
        ...
        _createInsertPanel: function () {
            var e = this.editor,
                ...
                l = [];
            (n.uploadImgShowBase64 || n.uploadImgServer || n.customUploadImg) && window.FileReader && l.push(
                s[0]), n.showLinkImg && l.push(s[1]);
            var d = new f(this, {
                width: 300,
                tabs: l
            });
        ...
        tryChangeActive: function (e) {
            var t = this.editor,
                n = this.$elem;
            t._selectedImg ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass(
                "w-e-active"))
        }
    };
    var q = {};
    q.bold = l, q.head = u, q.fontSize = h, q.fontName = p, q.link = m, q.italic = g, q.redo = w, q.strikeThrough =
        v, q.underline = E, q.undo = b, q.list = B, q.justify = y, q.foreColor = C, q.backColor = x, q.quote = I, q
        .code = Q, q.emoticon = M, q.table = S, q.video = k, q.image = D, _.prototype = {
            constructor: _,
            init: function () {
                var e = this,
                    t = this.editor;
                ...
                A(e, function (e, n) {
                    ...
                    if (i) {
                        ...
                        "click" === i && n.onClick && o.on("click", function (e) {
                            ...
                            null != t.selection.getRange() && (A.showTimeoutId = setTimeout(
                                function () {
                                    A.show()
                                }, 200))
                ...
                function n(e) {
                    ...
                    if (t) {
                        ...
                        if ("CODE" === A && "PRE" === r && i.cmd.queryCommandSupported("insertHTML")) {
                            ...
                            i.cmd.do("insertHTML", "\n"), i.selection.saveRange(), i.selection.getRange().startOffset ===
                                a && i.cmd.do("insertHTML", "\n");
                            var s = t.html().length;
            ...
            _clearHandle: function () {
                ...
                t.on("keydown", function (e) {
                    if (8 === e.keyCode) {
                        return "<p><br></p>" === t.html().toLowerCase().trim() ? void e.preventDefault() :
                            void 0
                    }
                    ...
                    if (8 === n.keyCode) {
                        ...
                        A && "<br>" !== A || (i = o("<p><br/></p>"), t.html(""), t.append(i), e.selection
                            .createRangeByElem(i, !1, !0), e.selection.restoreSelection())
                    }
                })
            },
                    ...
                    if (!J.isIE() && (i.preventDefault(), e())) {
                        ...
                        if (l) {
                            ...
                            try {
                                ...
                                A && s(A) && (a = "" + (A(a) || "")), n.cmd.do("insertHTML", "<p>" + a +
                                    "</p>")
                            }
                        }
                    }
                    ...
                    if (9 === t.keyCode && e.cmd.queryCommandSupported("insertHTML")) {
                        ...
                        if (n) {
                            var i = n.parent(),
                                o = n.getNodeName(),
                                A = i.getNodeName();
                            "CODE" === o && "PRE" === A ? e.cmd.do("insertHTML", "    ") : e.cmd.do(
                                "insertHTML", "&nbsp;&nbsp;&nbsp;&nbsp;"), t.preventDefault()
                        }
                    }
                })
            },
            _imgHandle: function () {
                ...
                t.on("click", "img", function (t) {
                    var n = this,
                        i = o(n);
                    "1" !== i.attr("data-w-e") && (e._selectedImg = i, e.selection.createRangeByElem(i),
            ...
            do: function (e, t) {
                var n = this.editor;
                if (n._useStyleWithCSS || (document.execCommand("styleWithCSS", null, !0), n._useStyleWithCSS = !
                        0), n.selection.getRange()) {
            ...
            _insertHTML: function (e) {
                ...
                this.queryCommandSupported("insertHTML") ? this._execCommand("insertHTML", e) : n.insertNode ?
                    (n.deleteContents(), n.insertNode(o(e)[0])) : n.pasteHTML && n.pasteHTML(e)
            },
            ...
            createEmptyRange: function () {
                ...
                if (t && this.isSelectionEmpty()) try {
                    J.isWebkit() ? (e.cmd.do("insertHTML", "&#8203;"), t.setEnd(t.endContainer, t.endOffset +
                        1), this.saveRange(t)) : (n = o("<strong>&#8203;</strong>"), e.cmd.do(
                        "insertElem", n), this.createRangeByElem(n, !0))
                } catch (e) {}
            },
            createRangeByElem: function (e, t, n) {
                if (e.length) {
                    ...
                    n ? o.selectNodeContents(i) : o.selectNode(i), "boolean" == typeof t && o.collapse(t), this
                        .saveRange(o)
                }
            }
        }, H.prototype = {
            ...
            show: function (e) {
                ...
                if (!this._isShow) {
                    ...
                    Date.now() - this._time > 100 && e <= 1 && (n.css("width", 100 * e + "%"), this._time =
                        Date.now());
            ...
            if (e && e.length) {
                ...
                if (w || o || c) {
                    ...
                    if (r(e, function (e) {
                            var t = e.name,
                                n = e.size;
                            if (t && n) return !1 === /\.(jpg|jpeg|png|bmp|gif|webp)$/i.test(t) ? void E
                                .push("【" + t + "】不是图片") : a < n ? void E.push("【" + t + "】大于 " + s +
                                    "M") : void v.push(e)
                    ...
                    if (r(v, function (e) {
                        ...
                        var y = B[1] || "";
                        A(u, function (e, t) {
                            h && (o.indexOf("?") > 0 ? o += "&" : o += "?", o = o + e + "=" + t), b
                                .append(e, t)
                        }), y && (o += "#" + y);
                        var C = new XMLHttpRequest;
                        if (C.open("POST", o), C.timeout = m, C.ontimeout = function () {
                                f.timeout && "function" == typeof f.timeout && f.timeout(C, n), t._alert(
                                    "上传图片超时")
                                ...
                                var e = void 0;
                                if (4 === C.readyState) {
                                    if (C.status < 200 || C.status >= 300) return f.error && "function" ==
                                        typeof f.error && f.error(C, n), void t._alert("上传图片发生错误",
                                    ...
                                    if (f.customInsert || "0" == e.errno) {
                                        if (f.customInsert && "function" == typeof f.customInsert) f.customInsert(
                                            t.insertLinkImg.bind(t), e, n);
                                        else {
                                    ...
                                    } else f.fail && "function" == typeof f.fail && f.fail(C, n, e), t._alert(
                                        "上传图片失败", "上传图片返回结果错误，返回结果 errno=" + e.errno)
                                }
                            }, f.before && "function" == typeof f.before) {
                            var x = f.before(C, n, v);
                            if (x && "object" === (void 0 === x ? "undefined" : X(x)) && x.prevent) return void this
                                ._alert(x.msg)
                        }
    ...
    j.prototype = {
        ...
        _initDom: function () {
            ...
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s),
                a.css("background-color", "#f1f1f1").css("border", "1px solid #ccc"), s.css("border",
                    "1px solid #ccc").css("border-top", "none").css("height", "300px")) : (a = n, s = o(
                i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css(
                "width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o(
                "<p><br></p>")), s.append(l), a.addClass("w-e-toolbar"), s.addClass(
                "w-e-text-container"), s.css("z-index", r), l.addClass("w-e-text");
            var u = c("toolbar-elem");
            a.attr("id", u);
            var h = c("text-elem");
            l.attr("id", h), this.$toolbarElem = a, this.$textContainerElem = s, this.$textElem = l, this.toolbarElemId =
                u, this.textElemId = h;
            var p = !0;
        ...
        initSelection: function (e) {
            ...
            if (e) {
                var A = i.html().toLowerCase(),
                    r = i.getNodeName();
                if ("<br>" !== A && "<br/>" !== A || "P" !== r) return t.append(o("<p><br></p>")), void this
                    .initSelection()
            }
    ...
    try {
        ...
        "function" != typeof Object.assign && (Object.assign = function (e, t) {
            ...
            Element.prototype.webkitMatchesSelector || function (e) {
                for (var t = (this.document || this.ownerDocument).querySelectorAll(e), n = t.length; --n >= 0 &&
                    t.item(n) !== this;);
                return n > -1
            })
    }();
